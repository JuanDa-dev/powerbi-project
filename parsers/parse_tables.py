...
class TableParser:
    ...
    def parse(self, relationships: List[Dict[str, Any]] = None, measures: List[Dict[str, Any]] = None) -> List[Dict[str, Any]]:
        ...
        Args:
            relationships: Optional list of relationship dicts from parse_relationships
            measures: Optional list of measure dicts from parse_measures
...
def parse_tables(tmdl_dir: str, output_file: str = None, relationships: List[Dict[str, Any]] = None, measures: List[Dict[str, Any]] = None) -> List[Dict[str, Any]]:
    """
    Main function to parse tables.

    Args:
        tmdl_dir: Path to TMDL directory
        output_file: Optional output file path
        relationships: Optional list of relationships for unused table detection
        measures: Optional list of measures for unused table detection

    Keeps backward-compatible output as a list.
    """
    parser = TableParser(tmdl_dir)
    tables = parser.parse(relationships=relationships, measures=measures)
